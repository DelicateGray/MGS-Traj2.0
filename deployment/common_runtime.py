"""TensorRT官方例程里扒的，详情见：https://github.com/NVIDIA/TensorRT/blob/release/10.6/samples/python/common_runtime.py"""
...
def allocate_buffers(engine: trt.ICudaEngine, batch_size: int, profile_idx: Optional[int] = None):
    inputs = []
    outputs = []
    bindings = []
...
def do_inference(context, engine, bindings, inputs, outputs, stream):
    ...
    t1 = time.time()
    out = _do_inference_base(inputs, outputs, stream, execute_async_func)
    t2 = time.time()
