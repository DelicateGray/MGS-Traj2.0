...
def create_args():
    ...
    parser.add_argument(
        "--input_path",
        default="D:/ProgramFiles/DataSets/HighD/data/10_tracks.csv",
        type=str,
        help="CSV file of the tracks",
    )
    parser.add_argument(
        "--input_static_path",
        default="D:/ProgramFiles/DataSets/HighD/data/10_tracksMeta.csv",
        type=str,
        help="Static meta data file for each track",
    )
    parser.add_argument(
        "--input_meta_path",
        default="D:/ProgramFiles/DataSets/HighD/data/10_recordingMeta.csv",
        type=str,
        help="Static meta data file for the whole video",
    )
    parser.add_argument(
        "--pickle_path",
        default="D:/ProgramFiles/DataSets/HighD/track_pkl/10_tracks.pkl",
        type=str,
    ...
    parser.add_argument(
        "--background_image",
        default="D:/ProgramFiles/DataSets/HighD/data/10_highway.png",
        type=str,
...
if __name__ == "__main__":
    ...
    if created_arguments["visualize"]:
        ...
        visualization_plot.save_animation(
            "D:/ProgramFiles/DataSets/HighD/10_tracks.gif",
            fps=30,
